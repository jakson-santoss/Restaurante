...
def Invoices():
    ...
    topo = [[sg.Menu(menu_def, tearoff=False)],
            [sg.Text(" Software de Gerenciamento de Restaurante ", font=ftTT, expand_x=True,
                     text_color='lime', justification='center', relief='groove', p=(5, 10))],
    ...
    coluna_D = [[sg.T(f'R$ {Preco_Prod[pos]:2.2f}', text_color='black', s=(9, 1), font=ftPd),
                 sg.T(k='-TOT-' + prod + '-', background_color='white', size=(9, 1),
                      text_color='black', font=ftPd)]
                for pos, prod in enumerate(Nome_Prod)]
    ...
    #layout = [topo, [sg.TabGroup([[sg.Tab('produtos',coluna_E), sg.Tab('Preços',coluna_D, p=(0, 0))]])], rodape]
